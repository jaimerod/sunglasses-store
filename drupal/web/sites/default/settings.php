...
// Add dotenv for privacy and security
 ...
 * @endcode
 */
$settings['hash_salt'] = 'yrSa0S-NiSuKyJTv9SRbo5-xhO5vpQWpOZUSdkZRGgxUqI-a9x_K3sfrJKPPXgAX4wWClGAnlg';
 ...
 */
// $settings['http_client_config']['proxy']['http'] = 'http://localhost:3000';
// $settings['http_client_config']['proxy']['https'] = 'http://localhost:3000';
 ...
 */
$settings['reverse_proxy_addresses'] = ['172.20.0.4'];
...
$settings['config_sync_directory'] = 'sites/default/files/config_wIWdM7w4lxdmYNYRaHF6yZuuo3atMz1r6UC0G64E2mVk0W53_6yD5pcB_XsQCFk2ygUpCVbpEQ/sync';

/**
 * Database settings
 */
$databases['default']['default'] = array (
  'database' => (getenv('DBNAME')) ? getenv('DBNAME') : $_ENV['DBNAME'],
  'username' => (getenv('DBUSER')) ? getenv('DBUSER') : $_ENV['DBUSER'],
  'password' => (getenv('DBPASS')) ? getenv('DBPASS') : $_ENV['DBPASS'],
  'prefix' => '',
  'host' => (getenv('DBHOST')) ? getenv('DBHOST') : $_ENV['DBHOST'],
  'port' => '3306',
  'namespace' => 'Drupal\\Core\\Database\\Driver\\mysql',
  'driver' => 'mysql',
  // Not compatible with Maria DB 10
  // 'init_commands' => [
  //   'isolation_level' => 'SET SESSION transaction_isolation=\'READ-COMMITTED\'',
  // ],
);

$baseurl = parse_url((getenv('BASEURL')) ? getenv('BASEURL') : $_ENV['BASEURL']);
$settings['trusted_host_patterns'] = array(
    '^' . $baseurl['host'] . '$'
);
